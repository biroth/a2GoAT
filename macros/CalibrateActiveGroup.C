void CalibrateActiveGroup(Int_t nPoints=6){
  TChain *t1 = new TChain("detectorHits","detectorHits");
  /*
  TString sFile = "Acqu_CBTagg_13175-13186.root";

  t1->Add("Acqu_CBTagg_13175.root");
  t1->Add("Acqu_CBTagg_13176.root");
  t1->Add("Acqu_CBTagg_13177.root");
  t1->Add("Acqu_CBTagg_13178.root");
  t1->Add("Acqu_CBTagg_13179.root");
  t1->Add("Acqu_CBTagg_13180.root");
  t1->Add("Acqu_CBTagg_13181.root");
  t1->Add("Acqu_CBTagg_13182.root");
  t1->Add("Acqu_CBTagg_13184.root");
  t1->Add("Acqu_CBTagg_13186.root");
  */

  TString sFile = "Acqu_CBTagg_13191-13194.root";

  t1->Add("Acqu_CBTagg_13191.root");
  t1->Add("Acqu_CBTagg_13192.root");
  t1->Add("Acqu_CBTagg_13193.root");
  t1->Add("Acqu_CBTagg_13194.root");
